...
def genderStringToAnimate(genderString):
    if genderString == None:
        return None
...
def getWordInformation(word):
    ...
    return {
        ...
        'isAnimate': genderStringToAnimate(genderString),
...
TEST_CASES = {
    # Multiple solutions
    "absolvent": u'{"gender": "m", "isAnimate": true, "nominative": {"singular": ["absolvent"], "plural": ["absolventi"]}, "genitive": {"singular": ["absolventa"], "plural": ["absolvent\u016f"]}, "dative": {"singular": ["absolventu", "absolventovi"], "plural": ["absolvent\u016fm"]}, "accusative": {"singular": ["absolventa"], "plural": ["absolventy"]}, "vocative": {"singular": ["absolvente"], "plural": ["absolventi"]}, "locative": {"singular": ["absolventu", "absolventovi"], "plural": ["absolventech"]}, "instrumental": {"singular": ["absolventem"], "plural": ["absolventy"]}}',
    "kandelábr": u'{"gender": "m", "isAnimate": false, "nominative": {"singular": ["kandel\u00e1br"], "plural": ["kandel\u00e1bry"]}, "genitive": {"singular": ["kandel\u00e1bru"], "plural": ["kandel\u00e1br\u016f"]}, "dative": {"singular": ["kandel\u00e1bru"], "plural": ["kandel\u00e1br\u016fm"]}, "accusative": {"singular": ["kandel\u00e1br"], "plural": ["kandel\u00e1bry"]}, "vocative": {"singular": ["kandel\u00e1bre", "kandel\u00e1b\u0159e"], "plural": ["kandel\u00e1bry"]}, "locative": {"singular": ["kandel\u00e1bru"], "plural": ["kandel\u00e1brech"]}, "instrumental": {"singular": ["kandel\u00e1brem"], "plural": ["kandel\u00e1bry"]}}',
    "chlápek": u'{"gender": "m", "isAnimate": true, "nominative": {"singular": ["chl\u00e1pek"], "plural": ["chl\u00e1pci", "chl\u00e1pkov\u00e9"]}, "genitive": {"singular": ["chl\u00e1pka"], "plural": ["chl\u00e1pk\u016f"]}, "dative": {"singular": ["chl\u00e1pkovi", "chl\u00e1pku"], "plural": ["chl\u00e1pk\u016fm"]}, "accusative": {"singular": ["chl\u00e1pka"], "plural": ["chl\u00e1pky"]}, "vocative": {"singular": ["chl\u00e1pku"], "plural": ["chl\u00e1pkov\u00e9", "chl\u00e1pci"]}, "locative": {"singular": ["chl\u00e1pkovi", "chl\u00e1pku"], "plural": ["chl\u00e1pc\u00edch[1]"]}, "instrumental": {"singular": ["chl\u00e1pkem"], "plural": ["chl\u00e1pky"]}}',
    "jedenáctiúhelník": u'{"gender": "m", "isAnimate": false, "nominative": {"singular": ["jeden\u00e1cti\u00faheln\u00edk"], "plural": ["jeden\u00e1cti\u00faheln\u00edky"]}, "genitive": {"singular": ["jeden\u00e1cti\u00faheln\u00edka", "jeden\u00e1cti\u00faheln\u00edku"], "plural": ["jeden\u00e1cti\u00faheln\u00edk\u016f"]}, "dative": {"singular": ["jeden\u00e1cti\u00faheln\u00edku"], "plural": ["jeden\u00e1cti\u00faheln\u00edk\u016fm"]}, "accusative": {"singular": ["jeden\u00e1cti\u00faheln\u00edk"], "plural": ["jeden\u00e1cti\u00faheln\u00edky"]}, "vocative": {"singular": ["jeden\u00e1cti\u00faheln\u00edku"], "plural": ["jeden\u00e1cti\u00faheln\u00edky"]}, "locative": {"singular": ["jeden\u00e1cti\u00faheln\u00edku"], "plural": ["jeden\u00e1cti\u00faheln\u00edc\u00edch"]}, "instrumental": {"singular": ["jeden\u00e1cti\u00faheln\u00edkem"], "plural": ["jeden\u00e1cti\u00faheln\u00edky"]}}',
    # No plural
    "Ahaggar": u'{"gender": "m", "isAnimate": false, "nominative": {"singular": ["Ahaggar"], "plural": []}, "genitive": {"singular": ["Ahaggaru"], "plural": []}, "dative": {"singular": ["Ahaggaru"], "plural": []}, "accusative": {"singular": ["Ahaggar"], "plural": []}, "vocative": {"singular": ["Ahaggare"], "plural": []}, "locative": {"singular": ["Ahaggaru"], "plural": []}, "instrumental": {"singular": ["Ahaggarem"], "plural": []}}',
    # No forms other than nominative
    "aha": u'{"gender": "n", "isAnimate": false, "nominative": {"singular": ["aha"], "plural": []}, "genitive": {"singular": [], "plural": []}, "dative": {"singular": [], "plural": []}, "accusative": {"singular": [], "plural": []}, "vocative": {"singular": [], "plural": []}, "locative": {"singular": [], "plural": []}, "instrumental": {"singular": [], "plural": []}}',
    # Normal
    "jalovice": u'{"gender": "f", "isAnimate": false, "nominative": {"singular": ["jalovice"], "plural": ["jalovice"]}, "genitive": {"singular": ["jalovice"], "plural": ["jalovic"]}, "dative": {"singular": ["jalovici"], "plural": ["jalovic\u00edm"]}, "accusative": {"singular": ["jalovici"], "plural": ["jalovice"]}, "vocative": {"singular": ["jalovice"], "plural": ["jalovice"]}, "locative": {"singular": ["jalovici"], "plural": ["jalovic\u00edch"]}, "instrumental": {"singular": ["jalovic\u00ed"], "plural": ["jalovicemi"]}}',
    # No gender
    "naplat": u'null',
    # Multiple declension tables (we pick the first one)
    "haken": u'{"gender": "m", "isAnimate": true, "nominative": {"singular": ["haken"], "plural": ["hakeni", "hakenov\u00e9"]}, "genitive": {"singular": ["hakena"], "plural": ["haken\u016f"]}, "dative": {"singular": ["hakenu", "hakenovi"], "plural": ["haken\u016fm"]}, "accusative": {"singular": ["hakena"], "plural": ["hakeny"]}, "vocative": {"singular": ["hakene"], "plural": ["hakeni", "hakenov\u00e9"]}, "locative": {"singular": ["hakenovi", "hakenu"], "plural": ["hakenech"]}, "instrumental": {"singular": ["hakenem"], "plural": ["hakeny"]}}',
    # Multiple nouns tables (for now, we just take the first one)
    "pahejl": u'{"gender": "m", "isAnimate": false, "nominative": {"singular": ["pahejl"], "plural": ["pahejly"]}, "genitive": {"singular": ["pahejlu"], "plural": ["pahejl\u016f"]}, "dative": {"singular": ["pahejlu"], "plural": ["pahejl\u016fm"]}, "accusative": {"singular": ["pahejl"], "plural": ["pahejly"]}, "vocative": {"singular": ["pahejle"], "plural": ["pahejly"]}, "locative": {"singular": ["pahejlu"], "plural": ["pahejlech"]}, "instrumental": {"singular": ["pahejlem"], "plural": ["pahejly", "pahejlama"]}}'
}
